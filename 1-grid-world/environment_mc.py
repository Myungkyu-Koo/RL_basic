...
UNIT = 100  # Grid 한 칸당 pixel 수
HEIGHT = 5  # Grid world 세로 칸수
WIDTH = 5  # Grid world 가로 칸수
...
class Env(tk.Tk):
    ...
    def step(self, action):
        ...
        # Index 형태로 전달되는 action을 좌표변화값 base_action으로 변환
        if action == 0:  # Up
            if state[1] > UNIT:
                base_action[1] -= UNIT
        elif action == 1:  # Down
        ...
        # Rewards: 목적지에 도착하면 +100, 세모에 도착하면 -100
